    ...
    <DayPicker
      ...
      classNames={{
        ...
        day_button: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-l-md rounded-r-md hover:bg-blue-500 hover:text-white"
        ),

        range_end: "day-range-end",
        selected:
          "bg-blue-500 text-white hover:bg-blue-500 hover:text-gray-900 focus:bg-blue-500 focus:text-white rounded-l-md rounded-r-md",
